...
export default function AdminSectionClient({ section }: { section: string }) {
  ...
  switch (section) {
    ...
    case "city-monitor":
      return <CityIntelligenceViews view="city-monitor" />;
    case "energy-grid":
      return <CityIntelligenceViews view="energy-grid" />;
    case "water-monitor":
      return <CityIntelligenceViews view="water-monitor" />;
    case "waste-analytics":
      return <CityIntelligenceViews view="waste-analytics" />;
    case "impact-matrix":
    ...
    case "citizen-reports-queue":
      return <PeopleViews view="citizen-reports-queue" />;
    case "restaurant-ngo-partners":
      return <PeopleViews view="restaurant-ngo-partners" />;
    default:
      return <ControlCenterView />;
  }
}
